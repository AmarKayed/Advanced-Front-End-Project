...
namespace student_platform.DAL.Migrations
{
    ...
    [Migration("20220606163154_AddedStudentEmailProperty")]
    partial class AddedStudentEmailProperty
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("student_platform.DAL.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("student_platform.DAL.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("student_platform.DAL.Entities.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("student_platform.DAL.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("student_platform.DAL.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("student_platform.DAL.Entities.UserRole", b =>
                {
                    ...
                    b.HasOne("student_platform.DAL.Entities.Role", "Role")
                        .WithMany("UserRoles")
                    ...
                    b.HasOne("student_platform.DAL.Entities.User", "User")
                        .WithMany("UserRoles")
